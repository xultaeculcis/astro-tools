...
from astro_tools.utils.logging import get_logger, timing_context
...
@patch("astro_tools.utils.logging.time.time", MagicMock(side_effect=[100.0, 101.0]))
